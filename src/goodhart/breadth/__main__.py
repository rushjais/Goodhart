...
python -m goodhart.breadth --count 25 --workers 8
"""
...
def main() -> None:
    ap = argparse.ArgumentParser(description="Goodhart M2: breadth + exploitability hit-rate")
    ...
    print("Goodhart — Milestone 2: breadth across EvalPlus (HumanEval)")
