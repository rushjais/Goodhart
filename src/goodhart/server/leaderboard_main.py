"""`python -m goodhart.server.leaderboard_main --port 8100 [--db ...] [--seed]`.
...
def _ensure_port_free(host: str, port: int) -> None:
    ...
    try:
        ...
        raise SystemExit(
            ...
            f"  or:  python -m goodhart.server.leaderboard_main --port <N>"
        ) from None
    finally:
        probe.close()
...
def main() -> None:
    ap = argparse.ArgumentParser(prog="goodhart.server.leaderboard_main")
