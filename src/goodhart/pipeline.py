"""End-to-end Goodhart pipeline over an environment adapter — bring an env, get a verifier report.
...
@dataclass
class EnvAdapter:
    """Everything Goodhart needs from an environment; the loop itself is env-agnostic."""
